...
const actions = {
  ...
  ADD_GROUP({ commit }, params) {
    ...
    _this.$http.post('http://119.29.151.195:8080/ContactsBe/addGroup', params).then(response => {
  ...
  DEL_GROUP({ commit }, group, index) {
    _this.$http.post('http://119.29.151.195:8080/ContactsBe/delGroup', group).then(response => {
